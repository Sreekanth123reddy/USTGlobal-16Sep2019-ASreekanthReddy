...
public class EmployeeController {
	...
	@PostMapping("/update")
	public String updateProfile(String name,String password,Date doj,
		...
		if(check) {
		map.addAttribute("msg", "updated successfullly");
		}
		else {
			map.addAttribute("msg", "not updated successfullly");
		}
		return "home";
	}
}
